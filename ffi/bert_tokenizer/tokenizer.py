...
_convert_pairs.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_int]
_convert_pairs.restype = ctypes.c_int

_get_input_ids = _lib.get_input_ids
_get_input_mask = _lib.get_input_mask
_get_segment_ids = _lib.get_segment_ids

_get_input_ids.restype = ctypes.POINTER(ctypes.c_int32)
_get_input_mask.restype = ctypes.POINTER(ctypes.c_int32)
_get_segment_ids.restype = ctypes.POINTER(ctypes.c_int32)

_get_error = _lib.bert_tokenizer_get_error
...
class FullTokenizer(object):
    ...
    def convert_pairs(self, text_a, text_b, max_seq_len, is_pair):
